...
public class MainActivity extends AppCompatActivity {
    ...
    public static String URL =
            "http://api.openweathermap.org/data/2.5/weather?q=London,uk&appid=d7b900681c37193223281142bd919019";
    TextView textView;
    ...
    class GetWeatherInfo extends AsyncTask<String, Void, String>
    {
        ...
        protected String doInBackground(String... params)
        {
            ...
            try {
                ...
                String description = jsonObject_desc.optString("description").toString();
